...
public class member {
    ...
    public member getById(int id){
        ...
        try{
            ...
            {
                mbr = new member();
                mbr.setIdanggota(rs.getInt("idanggota"));
                mbr.setNama(rs.getString("nama"));
                mbr.setAlamat(rs.getString("alamat"));
                mbr.setTelepon(rs.getString("telepon"));
            }
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public ArrayList<member> getAll(){
        ArrayList<member> ListAnggota = new ArrayList();
