 ...
 * @author Balqis
 */
public class FormBooks extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        String[] kolom={"ID","Category","Title","Author","Publisher"};
        ArrayList<books> list =new books().getAll();
     ...
     public void cari(String keyword){
        String[] kolom={"ID","Category","Title","Author","Publisher"};
        ArrayList<books>list=new books().search(keyword);
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(txtPenulis, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
       DefaultTableModel model=(DefaultTableModel)tblBuku.getModel();
        ...
        books buku=new books().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
